...
const INPUT = "w-full border border-gray-200 dark:border-win-border-light rounded-2xl px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-300 placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-win-elevated dark:text-gray-100";
    ...
    <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full border border-gray-200 dark:border-win-border-light rounded-2xl pl-9 pr-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-300 placeholder-gray-400 dark:placeholder-gray-500 dark:bg-win-elevated dark:text-gray-100"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={wrapChange(handleChange)}
                className="w-full border border-gray-200 dark:border-win-border-light rounded-2xl pl-9 pr-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-300 dark:bg-win-elevated dark:text-gray-100"
              />
            </div>
          </div>
            ...
            <label
              ...
              className={`flex items-center gap-2 px-3 py-1.5 rounded-xl border text-xs font-medium cursor-pointer transition-colors ${
                formData[key]
                  ...
                  : "bg-white dark:bg-win-surface border-gray-200 dark:border-win-border-light text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-win-elevated/50"
              }`}
            >
              <input
                type="checkbox"
              ...
              <span className={`w-3.5 h-3.5 rounded-full border flex items-center justify-center flex-shrink-0 ${
                formData[key] ? "bg-sky-500 border-sky-500" : "border-gray-300 dark:border-win-border-light"
              }`}>
                {formData[key] && (
      ...
      <div className="flex justify-end gap-2 pt-1">
        <button
          type="button"
          onClick={onCancel}
          className="flex items-center gap-1.5 px-4 py-2 rounded-2xl border border-gray-200 dark:border-win-border-light text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-win-elevated/50 transition-colors"
        >
