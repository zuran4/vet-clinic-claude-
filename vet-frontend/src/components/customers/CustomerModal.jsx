    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" style={{ touchAction: "none" }}>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/70 text-xs mt-0.5">
                {initialData ? "Τροποποίηση στοιχείων" : "Συμπλήρωσε τα στοιχεία του πελάτη"}
              </p>
            </div>
          </div>
          <button
      ...
      {showConfirm && (
        <div className="absolute inset-0 z-20 flex items-center justify-center bg-black/30">
          <div className="bg-white dark:bg-win-surface rounded-2xl shadow-xl p-6 w-full max-w-sm mx-4">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-xl bg-amber-50 dark:bg-amber-900/20 flex items-center justify-center">
                <AlertTriangle className="w-5 h-5 text-amber-500 dark:text-amber-400" />
              </div>
              <div>
                <p className="font-semibold text-gray-800 dark:text-gray-100 text-sm">Άκυρη αλλαγές;</p>
            ...
            <div className="flex gap-2 justify-end mt-4">
              <button
                ...
                className="px-4 py-2 rounded-xl border border-gray-200 dark:border-win-border-light text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-win-elevated transition-colors"
              >
