...
const Modal = ({ isOpen, onClose, children, preventBackdropClose = false, noPadding = false }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Inner: scrollable */}
        <div className={`overflow-y-auto flex-1 scrollbar-thin scrollbar-thumb-rounded-full scrollbar-thumb-purple-400 hover:scrollbar-thumb-purple-500 scrollbar-track-gray-100 dark:scrollbar-track-win-elevated ${noPadding ? "" : "p-4 sm:p-6"}`}>
          {!noPadding && (
            <Button
              variant="ghost"
