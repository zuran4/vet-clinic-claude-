...
const AppointmentTypeForm = ({ time, onSave, onCancel }) => {
  ...
  return (
    <Modal isOpen={true} onClose={onCancel}>
      <div className="bg-white dark:bg-win-surface rounded-2xl p-6 w-96 shadow-xl space-y-4">
        {/* Τίτλος */}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <select
            ...
            className="w-full border border-gray-200 dark:border-win-border-light px-3 py-2 rounded-2xl shadow focus:ring-2 focus:ring-primary bg-white dark:bg-win-elevated text-gray-900 dark:text-gray-100"
          >
