            ...
            <>
              <div className="rounded-2xl border border-emerald-100 overflow-hidden">
                <ul className="divide-y divide-emerald-50">
                  {cart.map((p) => (
                    <li key={p.id} className="flex items-center justify-between px-3 py-2 bg-white gap-2">
              ...
              <div className={`rounded-2xl border transition-all overflow-hidden ${
                reminderEnabled ? "border-violet-200 bg-violet-50" : "border-gray-100 bg-gray-50"
              }`}>
                {/* Toggle header */}
                <button
                  type="button"
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`text-xs font-semibold ${reminderEnabled ? "text-violet-700" : "text-gray-500"}`}>
                  ...
                  <div className={`relative inline-flex h-4 w-7 items-center rounded-full transition-colors flex-shrink-0 ${
                    reminderEnabled ? "bg-violet-500" : "bg-gray-300"
                  }`}>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      {prod.retailPrice != null && (
                        <span className="text-xs font-semibold text-emerald-600">{Number(prod.retailPrice).toFixed(2)} €</span>
                      )}
